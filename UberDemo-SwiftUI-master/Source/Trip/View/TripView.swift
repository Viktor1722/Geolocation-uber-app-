...
struct TripView: View {
    ...
    let TextCurentLocation: LocalizedStringKey = "TextCurentLocation"
    let TextDestination: LocalizedStringKey = "TextDestination"
    let TextRides: LocalizedStringKey = "TextRides"
    let TextConfirm: LocalizedStringKey = "TextConfirm"
